...
const routes: Routes = [
    { path: "", component: ByCountryComponent, pathMatch: "full" }, // añadir  [routerLinkActiveOptions]="{exact: true}" en el html cuando la ruta esta vacia (pathMatch: "full") 
...
@NgModule({
    imports: [
        RouterModule.forRoot(routes) //aplicar rutas
    ],
    exports: [
        RouterModule
    ]
